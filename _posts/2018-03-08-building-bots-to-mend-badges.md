...
![Screenshot of a GitHub repo's README, with both working and broken badges]({{ "/assets/img/broken_badges.png" }})
...
![Screenshot of spam email messages ]({{ "/assets/img/spam.png" }})
...
![Gif of a puppy smiling and having a good time while getting patted]({{ "/assets/img/happy_puppy.gif" }})
...
![Diagram showing the branching problem of bug 2]({{ "/assets/img/bug2.png" }})
...
![Diagram showing the branching problem of bug 4]({{ "/assets/img/bug4.png" }})
...
![Screenshot of GitHub UI with a banner explaining that my account had been flagged.]({{ "/assets/img/github_flagged_account_banner.png" }})
