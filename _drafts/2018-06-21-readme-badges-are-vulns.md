...
Badges are a security vulnerability, and maintainers of projects should frame their thinking around them in that way. You shouldn't necessarily be concerned about it, but you should definitelty be aware of the risks they pose to your project.
...
A photographer was [tired of paying bandwidth costs](TODO:) and swapped out a politician's banner image with a photoshopped image of the politician having sex. Anytime you link to an image hosted by a third party, you are fundamentally trusting them not to swap out the contents.
...
Take a look at the badges that your projects are currently using and see who you are implicitly trusting today. Then make a conscious decision about whether the value provided by the badge outweighs the potential risks of allowing third-parties to host them.
